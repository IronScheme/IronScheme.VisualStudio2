...
namespace IronScheme.VisualStudio.REPL
{
    ...
    public sealed class SchemeConsolePackage : Package
    {
        /// <summary>
        ...
        /// </summary>
        public SchemeConsolePackage()
        {
            Trace.WriteLine(string.Format(CultureInfo.CurrentCulture, "Entering constructor for: {0}", this.ToString()));
            // This package has to proffer the IronScheme engine provider as a Visual Studio
            ...
            //container.AddService(typeof(ISchemeEngineProvider), callback, true);
        }
