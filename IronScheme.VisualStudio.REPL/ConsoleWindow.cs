...
namespace IronScheme.VisualStudio.REPL
{
    ...
    /// </summary>
    [Guid("B7298E4C-B8C6-4072-A770-8C00958B7DCC")]
    class ConsoleWindow : ToolWindowPane
    {
        ...
        /// <summary>
        /// Thread function used to run the IronScheme engine in a different thread.
        ...
        /// </summary>
        bool IsCurrentLineInputLine()
        {
            if (_textView.Caret.Position.BufferPosition == 0) return false;
        ...
        /// </summary>
        bool IsCurrentPositionInputPosition()
        {
        ...
        /// </summary>
        void SupportCommandOnInputPosition(object sender, EventArgs args)
        {
        ...
        /// </summary>
        void UnsupportedOnCompletion(object sender, EventArgs args)
        {
            MenuCommand command = sender as MenuCommand;
            if (null == command)
            {
        ...
        /// of the buffer.
        /// </summary>
        void OnShiftHome(object sender, EventArgs args)
        {
            SnapshotPoint start;
            if (IsCurrentLineInputLine())
            {
        ...
        /// </summary>
        void OnBeforeMoveLeft(object sender, EventArgs e)
        {
        ...
        /// </summary>
        void OnNoAction(object sender, EventArgs e)
        {
            // Do Nothing.
        }
        /// <summary>
        ...
        /// is used to execute the text as an IronScheme expression.
        /// </summary>
        ...
        int GetReadOnlyLength(ITextSnapshot textSnapshot)
        {
            int max = 0;
        ...
        /// </summary>
        void OnClearPane(object sender, EventArgs args)
        {
            if (!mefTextBuffer.EditInProgress)
            {
