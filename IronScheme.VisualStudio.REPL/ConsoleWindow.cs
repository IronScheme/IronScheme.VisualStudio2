...
namespace IronScheme.VisualStudio.REPL
{
    ...
    internal class ConsoleWindow : ToolWindowPane
    {
        ...
        protected override void Initialize()
        {
            ...
            IContentType ipContentType = registryService.GetContentType("scheme");
        ...
        private void InitializeEngine()
        {
            ...
            //ISchemeEngineProvider engineProvider = (ISchemeEngineProvider)globalProvider.GetService(typeof(ISchemeEngineProvider));
